...
from launch import LaunchDescription
from launch.actions import OpaqueFunction, DeclareLaunchArgument, SetEnvironmentVariable
...
custom_config_common = os.path.join(
...
# ZED Configurations to be loaded by ZED Node
custom_config_zedm = os.path.join(
    get_package_share_directory('zion_zed_ros2_interface'),
    'params',
    'zedm.yaml'
)
...
def launch_setup(context, *args, **kwargs):
    ...
    ##### Anis
    config_camera_path = custom_config_zedm
...
def generate_launch_description():
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                'config_path',
                default_value=TextSubstitution(text=custom_config_common),
